...
# for gamma in [0.97, 0.99, 0.95]:
# for vtrace_lambda in [0.97, 1.0, 0.5]:
# for min_episode_steps in [120 * 3 // 4, 115, 120, 0]:
for num_envs in [32, 64, 128, 256]:
    for env_seed, learn_seed in [(random_seed(), random_seed()) for _ in range(5)]:
        ...
        def update_fn(config: Args) -> Args:
            ...
            config.total_timesteps = 1280 * 16000  # 20_480_000. 1280 = lcm(20, 256)
